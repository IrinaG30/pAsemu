...
{
    public partial class CreaInteres : System.Web.UI.Page
    {
        ...
        private void ListarDatos()
        {
            try
            {
                GridViewDatos.DataSource = InteresNeg.ListarInteres(txtTipo.Text);
        ...
        protected void btnNuevoInteres_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/EditorInteres.aspx");
        }
        ...
        protected void GridViewDatos_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            //{
                ...
                {
                    InteresEnt.id = Convert.ToInt32(cod);
                }
                if (InteresNeg.EliminarInteres(InteresEnt) == true)
                {
                    ListarDatos();
                }
                //else
