<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreaFiadores.aspx.cs" Inherits="CapaPresentation.CreaFiadores" %>
...
<head runat="server">
    ...
    <title>Configuración y Parámetros: Fiadores</title>
                ...
                <div class="col-md-12">
                    ...
                    <h3>Roles</h3>
                        ...
                        <div class="form-group">
                            <asp:Label Text="Fiador: " runat="server" />
                            <asp:TextBox ID="txtFiador" CssClass="form-control" runat="server" />

                            <asp:Button ID="btnBuscar" runat="server" OnClick="btnBuscar_Click" Text="Buscar" />
                            <asp:Button ID="btnNuevoFiador" runat="server" OnClick="btnNuevoFiador_Click" Text="Nuevo" />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <asp:GridView ID="GridViewDatos" runat="server" AutoGenerateColumns="False" CellPadding="2" OnRowDeleting="GridViewDatos_RowDeleting" OnRowCommand="GridViewDatos_RowCommand" AllowPaging="True" OnPageIndexChanging="GridViewDatos_PageIndexChanging" PageSize="5" Width="900px">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="idTipoFiador" HeaderText="ID" />
                                    <asp:BoundField DataField="tipoFiador" HeaderText="Tipo Fiador" /> 
