<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditorPlazos.aspx.cs" Inherits="CapaPresentation.EditorPlazos" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Configurarción de Plazos</title>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtIdPlazo" CssClass="form-control" runat="server" ReadOnly="true" />
                    </div>

                    <div class="form-group">
                        <asp:Label Text="Plazo" runat="server" />
                        <asp:TextBox ID="txtPlazo" CssClass="form-control" runat="server"/>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtPlazo" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*Campo Requerido</asp:RequiredFieldValidator>
                    </div>
