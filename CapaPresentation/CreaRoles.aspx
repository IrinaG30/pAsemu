<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreaRoles.aspx.cs" Inherits="CapaPresentation.CreaRoles" %>
...
<head runat="server">
    ...
    <title>Configuración y Parámetros: Roles</title>
...
<body>
    <form id="form1" runat="server">
                ...
                <ul class="nav navbar-nav navbar-center">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="CreaUsuarios.aspx">UsUsUsuarios</a></li>
                        </ul>
                    </li>
                </ul>
                <%--Boton de log out--%>
        ...
        <%--CONTENEDOR DEL FORMULARIO PARA CREAR ROLES--%>
                ...
                <div class="col-md-12">
                    ...
                    <h3>Roles</h3>
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtTipoRol" CssClass="form-control" runat="server" />

                            <asp:Button ID="btnBuscar" runat="server" OnClick="btnBuscar_Click" Text="Buscar" />
                            <asp:Button ID="btnNuevoRol" runat="server" OnClick="btnNuevoRol_Click" Text="Nuevo" />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <asp:GridView ID="GridViewDatos" runat="server" AutoGenerateColumns="False" CellPadding="2" OnRowDeleting="GridViewDatos_RowDeleting" OnRowCommand="GridViewDatos_RowCommand" AllowPaging="True" OnPageIndexChanging="GridViewDatos_PageIndexChanging" PageSize="5" Width="900px">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="idRoles" HeaderText="ID" />
                                    <asp:BoundField DataField="tipoRol" HeaderText="Tipo Rol" /> 
