<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreaInteres.aspx.cs" Inherits="CapaPresentation.CreaInteres" %>
...
<head runat="server">
	...
	<title>Configuración y Parámetros: Interes</title>
...
<body>
	<form id="form1" runat="server">
		...
		<%--CONTENEDOR DEL FORMULARIO PARA CREAR INTERES--%>
				...
				<div class="col-md-12">
					...
					<h3>Roles</h3>
						...
						<div class="form-group">
							<asp:Label Text="Tipo de Interes: " runat="server" />
							<asp:TextBox ID="txtTipo" CssClass="form-control" runat="server" />

							<asp:Button ID="btnBuscar" runat="server" OnClick="btnBuscar_Click" Text="Buscar" />
							<asp:Button ID="btnNuevoInteres" runat="server" OnClick="btnNuevoInteres_Click" Text="Nuevo" />
						</div>


						<div class="form-group">

							<asp:GridView ID="GridViewDatos" runat="server" AutoGenerateColumns="False" CellPadding="2" OnRowDeleting="GridViewDatos_RowDeleting" OnRowCommand="GridViewDatos_RowCommand" AllowPaging="True" OnPageIndexChanging="GridViewDatos_PageIndexChanging" PageSize="5" Width="900px">
								...
								<Columns>
									...
									<asp:BoundField DataField="idInteres" HeaderText="ID" />
									<asp:BoundField DataField="porcentajeInteres" HeaderText="Porcentaje (%)" /> 
									<asp:BoundField DataField="tipoInteres" HeaderText="Tipo" /> 
