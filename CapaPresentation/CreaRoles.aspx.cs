...
{
    public partial class CreaRoles : System.Web.UI.Page
    {
        ...
        private void ListarDatos()
        {
            try
            {
                GridViewDatos.DataSource = RolesNeg.ListarRoles(txtTipoRol.Text);
        ...
        {
            Response.Redirect("~/EditorRoles.aspx");
        }
        ...
        protected void GridViewDatos_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            //{
                ...
                {
                    RolesEnt.id = Convert.ToInt32(cod);
                }
                if (RolesNeg.EliminarRol(RolesEnt) == true)
                {
                    ListarDatos();
                }
            //    else
