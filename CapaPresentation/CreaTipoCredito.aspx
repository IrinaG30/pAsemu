<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreaTipoCredito.aspx.cs" Inherits="CapaPresentation.CreaTipoCredito" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <%--CONTENEDOR DEL FORMULARIO PARA CREAR TIPOCREDITO--%>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtnombreCredito" CssClass="form-control" runat="server" />

                        <asp:Button ID="btnBuscar" runat="server" OnClick="btnBuscar_Click" Text="Buscar" />
                        <asp:Button ID="btnNuevoTipoCredito" runat="server" OnClick="btnNuevoTipoCredito_Click" Text="Nuevo" />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <asp:GridView ID="GridViewDatos" runat="server" AutoGenerateColumns="False" CellPadding="2" OnRowDeleting="GridViewDatos_RowDeleting" OnRowCommand="GridViewDatos_RowCommand" AllowPaging="True" OnPageIndexChanging="GridViewDatos_PageIndexChanging" PageSize="5" Width="900px">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="idTipoCredito" HeaderText="ID" />
                                <asp:BoundField DataField="nombreCredito" HeaderText="Tipo Crédito" />
