<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreaPlazos.aspx.cs" Inherits="CapaPresentation.CreaPlazos" %>
...
<body>
	<form id="form1" runat="server">
		...
		<%--CONTENEDOR DEL FORMULARIO PARA PLAZOS--%>
				...
				<div class="col-md-12">
					...
					<h3>Roles</h3>
						...
						<div class="form-group">
							...
							<asp:Button ID="btnNuevoPlazo" runat="server" OnClick="btnNuevoPlazo_Click" Text="Nuevo" />
						</div>
						...
						<div class="form-group">
							...
							<asp:GridView ID="GridViewDatos" runat="server" AutoGenerateColumns="False" CellPadding="2" OnRowDeleting="GridViewDatos_RowDeleting" OnRowCommand="GridViewDatos_RowCommand" AllowPaging="True" OnPageIndexChanging="GridViewDatos_PageIndexChanging" PageSize="5" Width="900px">
								...
								<Columns>
									...
									<asp:BoundField DataField="idPlazo" HeaderText="ID" />
