<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreaEstadoRegPrestamos.aspx.cs" Inherits="CapaPresentation.CreaEstadoRegPrestamo" %>
...
<head runat="server">
    ...
    <title>Configuración y Parámetros: Estado del Registro del Prestamo</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <%--CONTENEDOR DEL FORMULARIO PARA CREAR ESTADO REGISTRO PRESTAMO--%>
        <div class="container" style="background-color: white">
            <div class="row">
                <div class="col-md-12">

                    <h3>Estado de Registro de Prestamos</h3>
                        ...
                        <div class="form-group">
                            ...
                            <asp:GridView ID="GridViewDatos" runat="server" AutoGenerateColumns="False" CellPadding="2" OnRowDeleting="GridViewDatos_RowDeleting" OnRowCommand="GridViewDatos_RowCommand" AllowPaging="True" OnPageIndexChanging="GridViewDatos_PageIndexChanging" PageSize="5" Width="900px">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="idEstadoRegPrestamos" HeaderText="ID" />
