...
{
    public partial class CreaEstadoRegPrestamo : System.Web.UI.Page
    {
        EstadoRegPrestamosNegocio EstadoRegPrestamoNeg = new EstadoRegPrestamosNegocio();
        EstadoRegPrestamosEntidad EstadoRegPrestamoEnt = new EstadoRegPrestamosEntidad();
        ...
        private void ListarDatos()
        {
            try
            {
                GridViewDatos.DataSource = EstadoRegPrestamoNeg.ListarEstadoRegPrestamo(txtEstado.Text);
        ...
        {
            Response.Redirect("~/EditorEstadoRegPrestamo.aspx");
        }
        ...
        protected void GridViewDatos_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            //{
                ...
                {
                    EstadoRegPrestamoEnt.id = Convert.ToInt32(cod);
                }
                if (EstadoRegPrestamoNeg.EliminarEstadoRegPrestamo(EstadoRegPrestamoEnt) == true)
                {
                    ListarDatos();
                }
                else
