<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreaDepartamentos.aspx.cs" Inherits="CapaPresentation.CreaDepartamentos" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <%--CONTENEDOR DEL FORMULARIO PARA CREAR DEPARTAMENTOS--%>
                ...
                <div class="col-md-12">
                    ...
                    <h3>Departamentos</h3>
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtnombreDepartamento" CssClass="form-control" runat="server" />

                            <asp:Button ID="btnBuscar" runat="server" OnClick="btnBuscar_Click" Text="Buscar" />
                            <asp:Button ID="btnNuevoDepartamento" runat="server" OnClick="btnNuevoDep_Click" Text="Nuevo" />
                        </div>
