<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditorRoles.aspx.cs" Inherits="CapaPresentation.PruebaRoles" %>
...
<head runat="server">
    ...
    <title>Configurarción de Roles</title>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtIdRol" CssClass="form-control" runat="server" ReadOnly="true" />
                    </div>

                    <div class="form-group">
                        <asp:Label Text="Tipo de Rol" runat="server" />
                        <asp:TextBox ID="txtTipoRol" CssClass="form-control" runat="server"/>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtTipoRol" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*Campo Requerido</asp:RequiredFieldValidator>
                    </div>
