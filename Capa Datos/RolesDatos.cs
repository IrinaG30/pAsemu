...
namespace Capa_Datos
{
    public class RolesDatos
    {
        ...
        SqlConnection cnx;
        RolesEntidad mcEntidad = new RolesEntidad();
        ...
        public bool ActualizarRol(RolesEntidad mcEntidad)
        {
            cmd.Connection = cnx;
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "SP_ModificarRoles";
            try
            {
                cmd.Parameters.Add(new SqlParameter("@idRoles", SqlDbType.Int));
                cmd.Parameters["@idRoles"].Value = mcEntidad.id;
                cmd.Parameters.Add(new SqlParameter("@tipoRol", SqlDbType.VarChar, 50));
                cmd.Parameters["@tipoRol"].Value = mcEntidad.tipo;
                cnx.Open();
        ...
        public bool EliminarRol(RolesEntidad mcEntidad)
        {
            cmd.Connection = cnx;
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "SP_DesactivarRol";
            try
            {
                cmd.Parameters.Add(new SqlParameter("@idRoles", SqlDbType.Int));
                cmd.Parameters["@idRoles"].Value = mcEntidad.id;
        ...
        public DataTable ListarRoles(string parametro)
        {
            ...
            try
            {
                cmd.Connection = cnx;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "SP_ListarRoles";
                cmd.Parameters.Add(new SqlParameter("@tipoRol", parametro));
                SqlDataAdapter miada;
                miada = new SqlDataAdapter(cmd);
                miada.Fill(dts, "Roles");
            }
            ...
            return (dts.Tables["Roles"]);
        }

        public RolesEntidad BuscarRol(string id)
        {
            try
            {
                SqlDataReader dtr;
                cmd.Connection = cnx;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "SP_BuscarRol";
                cmd.Parameters.Add(new SqlParameter("@idRoles", SqlDbType.Int));
                cmd.Parameters["@idRoles"].Value = id;
