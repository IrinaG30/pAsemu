<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreaPuestos.aspx.cs" Inherits="CapaPresentation.CreaPuestos" %>
...
<head runat="server">
	...
	<title>Configuración y Parámetros: Puestos</title>
...
<body>
	<form id="form1" runat="server">
		...
		<%--CONTENEDOR DEL FORMULARIO PARA CREAR PUESTOS--%>
                ...
                <div class="col-md-12">
                    ...
                    <h3>Puestos</h3>
                        ...
                        <div class="form-group">
                            ...
                            <asp:Button ID="btnNuevoPuesto" runat="server" OnClick="btnNuevoPuesto_Click" Text="Nuevo" />
                        </div>
